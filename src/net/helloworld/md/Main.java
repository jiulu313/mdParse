...
import net.helloworld.md.parser.impl.MarkdownParserComposite;
import net.helloworld.md.utility.FileUtility;
...
public class Main {
    public static void main(String[] args) {
        ...
        FileUtility.getInstance().writeFile("/Users/jiulu/markdown.html", "<style>\n" +
                "    .bold{\n" +
                "        font-weight: bold;\n" +
                "    }\n" +
                "    .italic{\n" +
